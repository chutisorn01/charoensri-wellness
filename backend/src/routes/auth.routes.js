...
// Temporary route to seed all data from browser
router.get('/seed', async (req, res) => {
  try {
    ...
    res.status(200).json({ 
      success: true, 
      message: 'All sample data successfully seeded into database! You can now log in using admin / Charoensri@Admin2026!' 
    });
  } catch (err) {
